  ...
  return (
    <Switch>
      <Layout>
        <Route
          exact
          path={`${process.env.PUBLIC_URL}/elements/banners`}
          component={Banners}
        />
        <Route
          exact
        ...
        <Route
          exact
          path={`${process.env.PUBLIC_URL}/elements/products`}
          component={Products}
        />
        <Route
          exact
        ...
        <Route
          exact
          path={`${process.env.PUBLIC_URL}/elements/titles`}
          component={Titles}
        />
        <Route
          exact
          path={`${process.env.PUBLIC_URL}/elements/categories`}
          component={Categories}
        />
        <Route
          exact
          path={`${process.env.PUBLIC_URL}/elements/video-banners`}
        ...
        <Route
          exact
          path={`${process.env.PUBLIC_URL}/elements/testimonials`}
          component={Testimonials}
        />
        <Route
          exact
          path={`${process.env.PUBLIC_URL}/elements/portfolios`}
          component={Portfolios}
        />
        <Route
          exact
          path={`${process.env.PUBLIC_URL}/elements/cta`}
          component={CTA}
        />
        <Route
          exact
          path={`${process.env.PUBLIC_URL}/elements/icon-boxes`}
          component={IconBoxes}
        />
